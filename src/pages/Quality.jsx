    ...
    return (
        <div className="pt-5 mt-4">
            ...
            <section
                ...
                style={{
                    backgroundImage: "url('/assets/images/VMC machine.png')",
            ...
            >
                ...
                <Container className="position-relative z-1 py-5">
                    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                        <h1 className="display-3 fw-bold font-display mb-3">Quality Assurance</h1>
                        <p className="lead opacity-90 fw-light">Precision is not just a promise, it's our policy.</p>
                    </motion.div>
                </Container>
            </section>
